...
These are not three independent database designs. The schemas demonstrates the same data model changes throughout the migration process. Keeping each stage separate, distinguishes temporary migration structures from long-term application structures, and provides clear foundation for future persistence changes and application features.

## Editing and exporting from Draw.io on VSCode
