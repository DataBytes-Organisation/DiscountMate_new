...
import {
  ImageSearchResult,
  useImageSearch,
} from "../../app/(tabs)/ImageSearchContext";
import { useProductFilters } from "../../hooks/useProductFilters";

function buildImageSearchImageUrl(
  ...
  const retailers: Product["retailers"] = [
    {
      storeKey: "coles",
      name: "Coles",
      price: formatPrice(result.price_now),
      isCheapest: false,
    ...
    },
    {
      storeKey: "woolworths",
      name: "Woolworths",
      price: formatPrice(result.woolworths_price),
      isCheapest: false,
    },
    {
      storeKey: "iga",
      name: "IGA",
      price: formatPrice(result.iga_price),
      isCheapest: false,
    },
  ];
      ...
      <View className="w-full flex-row items-start">
        ...
        <View className="flex-1 px-4 md:px-8 py-8">
          ...
          <ProductGrid
            ...
            retailersFilter={filters.retailers}
            requireSearch
          />
        </View>
      </View>
